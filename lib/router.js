...
// 石家庄学院
router.get('/sjzc/www/:type?', require('./routes/universities/sjzc/www'));
router.get('/sjzc/jwc/:type?', require('./routes/universities/sjzc/jwc'));
router.get('/sjzc/xxzx/:type?', require('./routes/universities/sjzc/xxzx'));
router.get('/sjzc/lib/:type?', require('./routes/universities/sjzc/lib'));
